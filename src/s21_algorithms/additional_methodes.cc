...
/// @brief Метод s21::GraphAlgorithms::PrintAdjacencyMatrix() используется для вывода матрицы смежности на консоль.
///        Он принимает параметр adjacency_matrix, который представляет собой двумерный вектор (матрицу) целых чисел - матрицу смежности.
